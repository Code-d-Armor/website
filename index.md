...
Carrousel_Slides:
    - logo: /assets/img/slider/2024-devfestwhite-center.png
      ...
      subtitle2: 4 octobre 2024 - 8h30 - Perros-Guirec
      image:
...
Details:
  ...
  when:
    date: 4 octobre 2024
    time: accueil à 8h30, début à 9h15
  who:
...
Speakers:
  ...
  list:
    ...
    - name: "Aurélien Conte"
      id: "aurelien_conte"
      organization: "Heyliot"
      photo_url: "assets/img/photos_speakers/aurelien_conte.png"
      bio: >
        Membre de l'équipe R&D chez Heyliot depuis 2018, Aurélien Conte travaille au développement des fonctions cœur de la plateforme Heywaste. 
        Diplômé d'Epitech Rennes, il est passionné par les nouvelles technologies et l'IoT. Grâce à son expertise en développement logiciel, il contribue 
        à l'innovation dans la gestion intelligente des déchets et à la performance des solutions embarquées proposées par Heyliot.
    - name: "Tony Chouteau"
      id: "tony_chouteau"
      organization: "Mobil-inn"
      photo_url: "assets/img/photos_speakers/tony_chouteau.jpg"
      bio: >
        Ingénieur informatique diplômé de l'Enssat, Tony Chouteau occupe aujourd'hui le poste de directeur technique chez Mobil-inn. Il a réalisé l'interfaçage 
        avec Heyliot, permettant l'intégration des données dans le logiciel iSmartCollect. Engagé dans l'innovation technologique, il contribue à améliorer 
        la performance des solutions de Mobil-inn afin de faciliter les métiers de la collecte des déchets.
